...
const Filter = () => {
    ...
    const changeCategory =  (e) => {
        ...
        dispatch(sortBy({_sort:filterData,_order:filterHow}))
    };
                    ...
                    <div onClick={setClass}
                        ...
                        <div className={styles.filter__categories}>
                            ...
                            <ul onClick={changeCategory} className={styles.filter__choose}>
                                <li data-filteritem="popularity" className={styles["filter__choose__item"]}>по популярности</li>
                                <li data-filteritem="price" className={styles["filter__choose__item"]}>по цене</li>
                                <li data-filteritem="name" data-filterhow="asc" className={styles["filter__choose__item"]}>по алфавиту</li>
                            </ul>
                        </div>
                    </div>
                </div>
